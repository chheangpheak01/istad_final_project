  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <section>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white text-sm sm:text-base placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-offset-0 focus:ring-pink-500"
            />
          </div>
      ...
      <section>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-8 py-2 bg-white/5 border border-white/10 rounded-lg text-white text-sm sm:text-base placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-offset-0 focus:ring-pink-500"
          />
          <button
            type="button"
      ...
      <button
        ...
        className={`w-full py-2.5 rounded-lg font-medium text-white text-sm sm:text-base transition-all mt-4 cursor-pointer ${isLoading || !isValid
