export default function Sidebar({
  ...
  return (
    <aside
      className="w-full sm:w-80 bg-white shadow-lg rounded-b-2xl sm:rounded-r-2xl flex flex-col justify-between p-4 sm:p-6 mt-16 sm:mt-0 overflow-y-auto md:sticky md:top-20 lg:top-24 z-10"
