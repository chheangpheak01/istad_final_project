...
export function Popular() {
  const {
    ...
    handleCloseDetail,
    handleRetry,
  } = useMovieCategory((state) => state.movie.popular, fetchPopularMovies);
        ...
        <div className="pt-24 pb-8">
          <header className="text-center mb-12 px-4">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Discover the most popular movies right now. Browse through trending
              films from The Movie Database.
            </p>
