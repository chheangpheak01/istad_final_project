import { fetchAllMovies } from "../redux/movies/createAction";
...
export function More() {
    ...
    return (
        <>
                    ...
                    <div className="container mx-auto px-4">
                        <header className="text-center mb-12">
                            ...
                            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                                Browse our complete collection of movies. Discover films from all genres, years, and ratings in one place.
                            </p>
            ...
            {selectedMovie && (
                <MovieDetail movie={selectedMovie} isOpen={!!selectedMovie} onClose={handleCloseDetail} />
            )}
        </>
    );
}