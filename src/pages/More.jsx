import { loadMoreMovies } from "../redux/movies/createAction";
...
export function More() {
  const {
    ...
    handleCloseDetail,
    handleRetry,
  } = useMovieCategory((state) => state.movie.loadMore, loadMoreMovies);
            ...
            <div className="w-full max-w-[1600px] px-4 sm:px-6 lg:px-8">
              <header className="text-center mb-12">
                ...
                <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                  Browse our complete collection of movies. Discover films from all
                  genres, years, and ratings in one place.
                </p>
              ...
              <section aria-label="All movies list">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 mb-8 place-items-center">
                  {movies.map((movie) => (
                    <MovieCard
                      key={movie.id}
                      movie={movie}
