import { fetchUpcomingMovies } from "../redux/movies/createAction";
...
export function Upcoming() {
  const {
    ...
    handleCloseDetail,
    handleRetry,
  } = useMovieCategory((state) => state.movie.upcoming, fetchUpcomingMovies);
  ...
  if (status.includes("Failed")) {
    return (
      <main className="bg-gray-900 min-h-screen text-white pt-24 pb-8 flex items-center justify-center">
        ...
        <div className="pt-24 pb-8">
          <header className="text-center mb-12 px-4">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Discover movies that are coming soon to theaters. Be the first to
              know about upcoming releases.
            </p>
            <div className="mt-4 text-gray-400">
              <p>Showing {movies.length} upcoming movies</p>
          ...
          <section aria-label="Upcoming movies list">
