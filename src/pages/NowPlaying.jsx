...
export function NowPlaying() {
  const {
    ...
    handleCloseDetail,
    handleRetry,
  } = useMovieCategory((state) => state.movie.nowPlaying, fetchNowPlayingMovies);
        ...
        <div className="pt-24 pb-8">
          <header className="text-center mb-12 px-4">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Discover movies that are currently playing in theaters. Catch the latest
              releases while they're still on the big screen.
            </p>
